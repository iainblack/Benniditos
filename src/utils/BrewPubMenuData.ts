...
export const BrewPubMenuData: BenniditosMenuConfig = {
  pizza: {
    description1:
    ...
    column1: [
      ...
      },
      {
        name: "Margarita",
        description:
          "Garlic sauce, mozzarella & Romano cheese, fresh tomatoes & basil",
        small: "13.49",
        medium: "19.99",
        large: "27.99",
      },
      {
        name: "Greek Primo",
        description:
          "Red sauce, mozzarella & feta cheese, kalamata & green olives, roasted red peppers & pepperoncini",
        small: "15.99",
        medium: "23.99",
        large: "31.00",
      },
      ...
      },
      {
        name: "14th Ave Primo",
        description:
          "Pesto sauce, mozzarella & fontina cheeses, artichoke hearts, kalamata olives & fresh tomatoes",
        small: "15.99",
        medium: "25.99",
        large: "31.00",
      },
    ...
    column2: [
      ...
      },
      {
        name: "The High Drive",
        description:
          "Red sauce, mozzarella & fontina cheeses, Prosciutto & fresh red onions",
        small: "15.99",
        medium: "25.99",
        large: "29.99",
      },
      ...
      },
      {
        name: "Maui Wowie",
        description:
          "Pray for surf with red sauce, mozzarella & fontina cheese, prosciutto ham, pancetta bacon & pineapple",
        small: "16.99",
        medium: "25.99",
        large: "31.00",
      },
    ...
    bySlice: {
      description1: "No salad substitutions - mixed greens only",
      comboOptions: [
        {
          name: "Slice, Salad, Soda",
          subtitle: "(available 11-3PM)",
          options: [
            {
              topping: "Cheese",
              price: "7.99",
        ...
        {
          name: "Slice & a Pint",
          subtitle: "Applies to Bennidito's beer only",
          options: [
            {
  ...
  toppings: {
    ...
    sauces: ["Tomato", "Olive Oil", "Fresh Garlic"],
  },
  breads: {
    options: [
      {
        ...
        description:
          "Fresh baked pizza crust, topped with olive oil & aged parmesan",
        price: "9.99",
      },
      {
        name: "Cambozola Bread",
        description:
          "Bennidito’s Pizza Bread topped with roasted garlic & aged parmesan with Cambozola on the side",
        price: "18.99",
      },
      {
        name: "Garlic Bread",
  ...
  salads: {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Romaine lettuce mix, salami, roasted garlic, artichokes, fontina cheese, green olives, red onions, & pepperoncini with oil & vinegar dressing",
        small: "8.99",
        medium: "16.50",
        large: "24.00",
      },
  ...
  pasta: {
    description:
      "Pair one of our delicious pastas with your choice of any of our signature sauces & also enjoy a side of our new homemade pizza bread",
    ...
    sauces: [
      ...
      },
      {
        name: "Bolognese",
        description:
          "Marinara sauce, mushrooms, italian sausage, & our homemade meatballs",
        half: "7.00",
        whole: "13.00",
      },
      {
      ...
      },
      {
        ...
        description: "Bolognese sauce, sautéed meatballs & spaghetti",
        half: "8.00",
        whole: "15.00",
      },
      {
        ...
        description:
          "Your choice of spaghetti with marinara, bolognese sauce, or buttered noodles, a kid's drink, & chocolate ice cream",
        half: "6.00",
      },
    ],
  },
  ...
  sandwiches: {
    description:
      "All sandwiches come with kettle chips & pickle, or a sub salad for 2.00",
    hotSandwiches: [
      {
      ...
      {
        name: "Hot Pastrami",
        description: "Pastrami, swiss cheese, Russian dressing, & sauerkraut",
        half: "8.74",
        whole: "14.00",
      },
    ],
    coldSandwiches: [
      {
        name: "Sprague Beef Sammie",
        description:
          "Italian beef, lettuce, tomato, red onion, mayonnaise, & provolone with your choice of wasabi or horseradish",
        half: "8.00",
        whole: "13.50",
      },
      {
        name: "Canadian Bacon Sammie",
        description:
          "House smoked Canadian bacon, lettuce, tomato, red onion, mayonnaise, dijon mustard, & cheddar cheese",
        half: "8.50",
        whole: "12.50",
      },
      {
        name: "Italian Club",
        description:
          "Italian beef, Canadian bacon, prosciutto, lettuce, tomato, red onion, mayonnaise, dijon mustard, & cheddar cheese",
        half: "9.00",
        whole: "12.50",
      },
      {
        name: "Cold Pastrami",
        description:
          "Pastrami, lettuce, tomato, onion, provolone, horseradish, & mayo",
        half: "9.00",
        whole: "13.50",
      },
      {
        name: "Magnolia",
        description:
          "Canadian bacon, italian beef, lettuce, tomato, onion, mayo, mustard, & horseradish",
        half: "8.50",
        whole: "12.50",
      },
      {
        name: "Napa",
        description:
          "Pastrami, red onion, lettuce, tomato, provolone, & sweet hot mustard",
        half: "8.50",
        whole: "12.50",
      },
    ],
    calzones: [
      ...
      },
      {
        ...
        description:
          "Red sauce, mozzarella cheese, & any THREE toppings of your choice",
        price: "14.49",
      },
    ],
  },
